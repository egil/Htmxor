...
- Current implementation slice: the first bounded part of issue #151 makes
  `AddHtmxor()` / `AddHtmxorEndpoints()` current without changing issue #145's
  root or route-group mapping. Issue #151 remains open.
