...
initialized request components, and visibly swap deterministic shell-free
static SSR output. An unauthenticated DELETE returns `401`, and an authenticated
