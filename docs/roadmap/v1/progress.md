...
- Verified executable proof commit for issue #100: `a21bc827786b447dd14ae1df0c3f83cdc6f440bc`, based on exact fetched `origin/main` commit `d6e440f0fcb029174571979062705681b7a94d46`.
...
- Fast-profile proof at the same exact clean commit: `dotnet run --project eng/Htmxor.Quality/Htmxor.Quality.csproj --no-restore -- check --profile fast` recorded clean HEAD `a21bc827786b447dd14ae1df0c3f83cdc6f440bc`, passed 104 quality tests, 40 .NET 10 hosted tests, and 190 non-browser library, generator, analyzer, and runtime tests. Total: 334 discovered, 334 executed, 334 passed, 0 failed, 0 skipped, 0 errors, and 0 timeouts. The Release build produced 0 warnings and 0 errors.
...
- Issue #100 recognizes exactly one double-quoted simple `@onput` method group
  ...
  a multiline directive, a genuine binding preceded by a raw-string-valued
  attribute in the same tag, markup after code or control transitions,
