...
- This issue #106 progress change is documentation-only. Executable claims are tied to the tested executable proof commit above, not to the later documentation head.
