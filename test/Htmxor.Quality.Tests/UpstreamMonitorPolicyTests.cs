...
public sealed class UpstreamMonitorPolicyTests
{
	...
	public void Committed_manifest_tracks_exact_reviewed_relationships_and_dependencies()
	{
		...
		Assert.Equal(
			[
				...
				"src/Components/Endpoints/src/Builder/ResourceCollectionUrlMetadata.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateFormServices.cs|",
				"src/Components/Endpoints/src/CacheView/CacheView.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateCacheViewServices.cs|net11.0",
				"src/Components/Endpoints/src/CacheView/CacheViewRenderState.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateCacheViewServices.cs|net11.0",
				"src/Components/Endpoints/src/CacheView/CacheViewService.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateCacheViewServices.cs|net11.0",
				...
				"src/Components/Endpoints/src/DependencyInjection/RazorComponentsServiceOptions.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateFormServices.cs|",
				"src/Components/Endpoints/src/DependencyInjection/TempDataService.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateTempDataServices.cs|net11.0",
				"src/Components/Endpoints/src/DependencyInjection/WebAssemblyComponentSerializer.cs|file|none|reimplements|src/Htmxor/Endpoints/HtmxorEndpointCandidateRenderModeBoundary.cs|",
				"src/Components/Endpoints/src/DependencyInjection/WebAssemblySettingsEmitter.cs|file|none|reimplements|src/Htmxor/Endpoints/HtmxorEndpointCandidate.cs|net10.0",
				...
				"src/Components/Endpoints/src/Rendering/CacheViewTextWriter.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateCacheViewServices.cs|net11.0",
				"src/Components/Endpoints/src/Rendering/EndpointComponentState.cs|file|none|reimplements|src/Htmxor/Endpoints/HtmxorEndpointCandidateCacheViewServices.cs,src/Htmxor/Endpoints/HtmxorEndpointCandidateRenderer.CacheView.cs|",
				"src/Components/Endpoints/src/Rendering/EndpointHtmlRenderer.PrerenderingState.cs|file|none|reimplements|src/Htmxor/Endpoints/HtmxorEndpointCandidate.cs,src/Htmxor/Endpoints/HtmxorEndpointCandidateStateStore.cs|",
				...
				"src/Components/Endpoints/src/SessionCascadingValueSupplier.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateSessionServices.cs|net11.0",
				"src/Components/Endpoints/src/TempData/TempDataCascadingValueSupplier.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateTempDataServices.cs|net11.0",
				"src/Components/Endpoints/src/TempData/TempDataProviderServiceCollectionExtensions.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateTempDataServices.cs|net11.0",
				"src/Components/Endpoints/src/TempData/TempDataProviderServiceCollectionExtensions.cs|file|none|reimplements|src/Htmxor/Endpoints/HtmxorEndpointCandidate.cs|net11.0",
				"src/Components/Shared/src/ComponentKeyHelper.cs|file|none|mirrors|src/Htmxor/Endpoints/HtmxorEndpointCandidateCacheViewServices.cs|net11.0",
				"src/Components/Shared/src/RenderFragmentCapture.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateCacheViewServices.cs|net11.0",
	...
	private static IReadOnlyList<string> ProjectWatches(JsonElement manifest, string repositoryRoot)
	{
		...
		foreach (var watch in manifest.GetProperty("watches").EnumerateArray())
		{
			...
			// An absent "frameworks" property projects to an empty field, distinguishing a
			// watch that applies to every configured framework from one scoped to a subset,
			// so a stray or missing annotation among the fifty-two rows fails this assertion.
			var frameworks = watch.TryGetProperty("frameworks", out var scopedFrameworks)
				? string.Join(',', scopedFrameworks.EnumerateArray().Select(framework => framework.GetString()))
				: string.Empty;
