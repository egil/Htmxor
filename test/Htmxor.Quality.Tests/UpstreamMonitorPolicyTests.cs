	...
	public void Committed_manifest_tracks_exact_reviewed_relationships_and_dependencies()
	{
		...
		Assert.Equal(
			[
				...
				"src/Components/Endpoints/src/CacheView/CacheView.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateCacheViewServices.cs",
				"src/Components/Endpoints/src/CacheView/CacheViewRenderState.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateCacheViewServices.cs",
				"src/Components/Endpoints/src/CacheView/CacheViewService.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateCacheViewServices.cs",
				...
				"src/Components/Endpoints/src/DependencyInjection/TempDataService.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateTempDataServices.cs",
				...
				"src/Components/Endpoints/src/DependencyInjection/WebAssemblySettingsEmitter.cs|file|none|reimplements|src/Htmxor/Endpoints/HtmxorEndpointCandidate.cs",
				...
				"src/Components/Endpoints/src/Rendering/CacheViewTextWriter.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateCacheViewServices.cs",
				"src/Components/Endpoints/src/Rendering/EndpointComponentState.cs|file|none|reimplements|src/Htmxor/Endpoints/HtmxorEndpointCandidateCacheViewServices.cs,src/Htmxor/Endpoints/HtmxorEndpointCandidateRenderer.FragmentSelection.cs",
				...
				"src/Components/Endpoints/src/TempData/TempDataProviderServiceCollectionExtensions.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateTempDataServices.cs",
				"src/Components/Endpoints/src/TempData/TempDataProviderServiceCollectionExtensions.cs|file|none|reimplements|src/Htmxor/Endpoints/HtmxorEndpointCandidate.cs",
				"src/Components/Shared/src/ComponentKeyHelper.cs|file|none|mirrors|src/Htmxor/Endpoints/HtmxorEndpointCandidateCacheViewServices.cs",
				"src/Components/Shared/src/RenderFragmentCapture.cs|file|none|private-accesses|src/Htmxor/Endpoints/HtmxorEndpointCandidateCacheViewServices.cs",
