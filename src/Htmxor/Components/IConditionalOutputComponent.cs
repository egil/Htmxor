...
public interface IConditionalOutputComponent
{
	...
	/// <param name="directConditionalChildren">The number of direct child components that implements <see cref="IConditionalOutputComponent"/>.</param>
	/// <param name="conditionalChildren">The number of child/grand-child components that implements <see cref="IConditionalOutputComponent"/>.</param>
