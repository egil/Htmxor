...
using Htmxor.FormMapping.Converters.CollectionAdapters;
        ...
        out bool found)
    {
        ...
        if (index > maxCollectionSize && foundCurrentElement)
        {
            ...
            context.AddMappingError(
                FormattableStringFactory.Create("The number of elements in the {0} exceeded the maximum number of '{1}' elements allowed.", "collection", maxCollectionSize),
                null);
