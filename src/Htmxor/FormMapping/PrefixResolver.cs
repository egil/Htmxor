        ...
        public int Compare(FormKey x, FormKey y)
        {
            ...
            while (separatorX != -1 && separatorY != -1)
            {
                ...
                if (separatorX == -1 && separatorY == -1)
                {
                    ...
                    return x.Value.Span[currentXPos..].CompareTo(y.Value.Span[currentYPos..], StringComparison.Ordinal);
                }
                ...
                else if (separatorY == -1)
                {
                    ...
                    var match = x.Value.Span[currentXPos..][..separatorX].CompareTo(
                ...
                var compareResult = segmentX.CompareTo(segmentY, StringComparison.Ordinal);
                if (compareResult != 0)
                {
