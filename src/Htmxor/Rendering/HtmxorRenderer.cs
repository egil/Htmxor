...
/// </summary>
public sealed class HtmxorRenderer : IDisposable, IAsyncDisposable
{
    private readonly StaticHtmxorRenderer _passiveHtmlRenderer;

    /// <summary>
    /// Constructs an instance of <see cref="HtmxorRenderer"/>.
    /// </summary>
    /// <param name="services">The services to use when rendering components.</param>
    /// <param name="loggerFactory">The logger factory to use.</param>
    public HtmxorRenderer(IServiceProvider services, ILoggerFactory loggerFactory)
    {
        _passiveHtmlRenderer = new StaticHtmxorRenderer(services, loggerFactory);
    }
