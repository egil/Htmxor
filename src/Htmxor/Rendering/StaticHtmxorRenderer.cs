...
/// <see cref="HtmxorRenderer"/> for a more convenient API.
/// </summary>
internal partial class StaticHtmxorRenderer : Renderer
{
    ...
    public StaticHtmxorRenderer(IServiceProvider serviceProvider, ILoggerFactory loggerFactory)
